...
// import SPSelectField from '@/components/Forms/SPSelectField';
...
//    return (
//       <SPFullScreenModal open={open} setOpen={setOpen} title='Update Profile'>
//          <SPForm
...
//                   <SPInput name='name' label='Name' sx={{ mb: 2 }} fullWidth />
//                </Grid>
//                <Grid item xs={12} sm={12} md={4}>
//                   <SPInput
//                      name='email'
